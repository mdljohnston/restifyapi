...
var multiple = new nconf.Provider({
  stores: [
    { name: 'user', type: 'file', file: path.join(__dirname, 'user-config.default.json') },
    { name: 'global', type: 'global', file: path.join(__dirname, 'global-config.default.json') }
  ]
});
...
//
nconf.use('file', { file: path.join(__dirname, 'config.default.json') });
...
nconf.save(function (err) {
  fs.readFile(path.join(__dirname, 'config.default.json'), function (err, data) {
